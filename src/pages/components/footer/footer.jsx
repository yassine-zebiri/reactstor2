...
<ul>
    <li><Link to="f"><img src="/img/outline_add_card_white_48dp.png" alt=""  /></Link></li>
</ul>
</div>
</div>
...
<img className="" src="/img/icon-and.png" alt=""  />
</Link>

<Link to="zdf" className="Y-footer-box-2-2-b">
<img className="" src="/img/icon-iso.png" alt=""  />
</Link>
...
<li><Link to='ff'><img src="/img/icon-facebook.png" alt="" /></Link></li>
<li><Link to='ff'><img src="/img/icon-twitter.png" alt="" /></Link></li>
<li><Link to='ff'><img src="/img/icon-yt.png" alt="" /></Link></li>
<li><Link to='ff'><img src="/img/icon-in.png" alt="" /></Link></li>
